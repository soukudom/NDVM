...
def class_similarity(df, feature_cols, label_col, base_class=None, max_epochs=50):
    ...
    model = train_ae(df[df[label_col] == base_class][feature_cols], max_epochs=max_epochs)
    model.eval()
